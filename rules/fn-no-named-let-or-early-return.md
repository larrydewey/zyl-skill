...
- A body with `ensures` loses its tail calls: the postcondition runs after the call ([contract-checks-and-profiles](contract-checks-and-profiles.md)).
