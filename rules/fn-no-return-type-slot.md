...
- Annotations are not enforced (see [type-inference-does-not-reject](type-inference-does-not-reject.md)) but they do change code generation (see [fn-annotate-string-float-params](fn-annotate-string-float-params.md)).
